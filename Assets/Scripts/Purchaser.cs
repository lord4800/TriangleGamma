...
namespace CompleteProject
{
    ...
    public class Purchaser : MonoBehaviour, IStoreListener
    {
        ...
        private static string kProductNameAppleConsumable = "/*com.MentosTeam.Triangle.services.purchasing.mentos_triangle_coin_1*/";             // Apple App Store identifier for the consumable product.
        private static string kProductNameAppleNonConsumable = "com.unity3d.test.services.purchasing.nonconsumable";      // Apple App Store identifier for the non-consumable product. (Нельзя купить повторно)
        private static string kProductNameAppleSubscription = "";       // Apple App Store identifier for the subscription product.

        private static string kProductNameGooglePlayConsumable = "mentos_triangle_free_1"; //mentos_triangle_ads_1       // Google Play Store identifier for the consumable product.
        ...
        private static string kProductNameGooglePlaySubscription = "mentos_triangle_coin_1";  // Google Play Store identifier for the subscription product.
        ...
        public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args)
        {
            ...
            if (String.Equals(args.purchasedProduct.definition.id, kProductIDConsumable, StringComparison.Ordinal))
            {
                ...
                MAIN.MaxCoins += 100;
                AdMobPlugin.ADM = 1;
                PlayerPrefs.SetInt("ADM", AdMobPlugin.ADM);
                PlayerPrefs.Save();
            }
