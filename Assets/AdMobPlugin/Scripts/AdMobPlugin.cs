...
public class AdMobPlugin : MonoBehaviour{
   ...
   // static public int ADM = PlayerPrefs.GetInt("ADM", 0);  //для включения раскоментить? или вообще убрать? короче не мог потестить 
    static public int ADM = 0;  // короче 0 - реклама есть 1-нету
